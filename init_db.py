...
def create():
    ...
    db.execute(
        "CREATE TABLE IF NOT EXISTS foods (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, product_calories, consumed_calories TEXT NOT NULL, user_id INTEGER NOT NULL, barcode INTEGER NOT NULL, grams INTEGER NOT NULL, created_at TEXT DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY(user_id) REFERENCES users(id))"
    )
